...
import controller.view.BirthdayStatisticsController;
...
public class MainApp extends Application {
    ...
    public void start(Stage primaryStage) {
        ...
        this.primaryStage.getIcons().add(new Image("file:resources/images/cbs.jpg"));
    ...
    public boolean showPersonEditDialog(Person person) {
        try {
            ...
            dialogStage.getIcons().add(new Image("file:resources/images/cbs.jpg"));
